      ...
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-lg-6 mx-auto text-center">
            ...
            <p data-aos="fade-up">
              Even being in front of that humble username and password input field, it feels like a
              key to unlock the door to my life. It is the moment when I can reveal my identity as
              my true self.
            </p>
          </div>
        </div>
