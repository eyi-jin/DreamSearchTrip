    ...
    methods: {
        ...
        getListItem(places) {
            var el = document.createElement("div"),
                itemStr = ` <div class="p-4 rounded job-position m-3" style="background-color: #ffffff; background-color: rgba( 255, 255, 255, 0.7 )">
	                    <div class="row">
		                  <div class="col-lg-12">
			                <h5>${places.title}</h5> `;
            ...
            itemStr += ` 
                                  <div class="d-flex justify-content-end mt-2">
                                    <button class="btn btn-primary" style="padding:3px 20px">Add</button>
                                    </div>
        </div>
                  		</div>
                  	</div>
            ...
            this.positions.forEach((position) => {
              ...
              <div class="card">
                ...
                itemEl.onclick = async () => {
                    let url = `/fav/favRegist`;
                    let params = {
                        contentId: position.contentId,
                        favName: position.title,
                    ...
                    if (data.result == "success") {
                        this.$alertify.success("my trip에 추가!");
                    } else {
                        this.$alertify.error("my trip에 추가 실패!");
                    }
                };
