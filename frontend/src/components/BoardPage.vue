    ...
    <div>
        <div class="hero overlay">
            <div class="img-bg rellax">
                <img src="images/europe.png" alt="Image" class="img-fluid" />
            </div>
            <div class="container">
                <div class="row align-items-center justify-content-start">
                    <div class="col-lg-5">
                        ...
                        <p class="mb-5" data-aos="fade-up">
                            Boards provide us with connections to unknown people, and are
                            places to share knowledge and experience. In it, we can
                            understand and encourage each other, and get a new
                            perspective.
                        </p>
                    </div>
                </div>
